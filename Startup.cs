...
namespace SecondServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IEmployeeData , EmployeeService>();
            services.AddScoped<IPostsData , PostsService>();
            services.AddHttpClient<IQuranData , QuranService>(op => {

                op.BaseAddress = new Uri("https://localhost:6001/");
